# nvim-treesitter-queries-sosl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sosl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sosl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sosl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sosl",
...
- [ ] Changes are scoped to `sosl` — do not include files for other languages
